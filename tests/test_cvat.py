...
def test_import_cvat_builds_reviewed_player_reference_and_keeps_other_labels(tmp_path) -> None:
    ...
    provenance = {
        ...
        "shots": {"shot-0": {"source_shot_id": "shot-0", "start_frame": 1, "end_frame": 8, "start_pts": pts[1], "play_id": "play-1", "split": "development", "camera_label": "sideline"}},
    ...
    xml_path.write_text(f'''<annotations>
      ...
      <track id="13" label="timing_event"><points frame="3" points="0,0" outside="0" occluded="0" keyframe="1"><attribute name="event">snap</attribute><attribute name="source_pts">{pts[3]}</attribute><attribute name="play_id">play-1</attribute><attribute name="correspondence_id">snap</attribute><attribute name="play_time_s">0</attribute><attribute name="review_status">reviewed</attribute></points></track>
      <track id="14" label="calibration_landmark"><points frame="2" points="4,5" outside="0" occluded="0" keyframe="1"><attribute name="source_pts">{pts[2]}</attribute><attribute name="landmark_id">yardline:20:sideline:near</attribute><attribute name="field_x_yards">20</attribute><attribute name="field_y_yards">0</attribute><attribute name="role">fit</attribute><attribute name="review_status">reviewed</attribute></points></track>
